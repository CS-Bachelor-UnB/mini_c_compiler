...
compile: src/scanner.l src/parser.y utilities.o symbolTable.o syntaxTree.o functionCall.o
	mkdir -p assets/ bin/
	...
	gcc $(CFLAGS) src/aux/lex.yy.c src/aux/y.tab.c obj/utilities.o obj/symbolTable.o obj/syntaxTree.o obj/functionCall.o -o bin/compile -I include/
